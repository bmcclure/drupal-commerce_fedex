...
use Arkitecht\FedEx\Enums\PhysicalPackagingType;
...
use Arkitecht\FedEx\Structs\Weight as FedexWeight;
use Arkitecht\FedEx\Enums\WeightUnits as FedexWeightUnits;
use Arkitecht\FedEx\Enums\LinearUnits as FedexLengthUnits;
...
class FedEx extends ShippingMethodBase {
  ...
  protected function getFedExShipment(ShipmentInterface $shipment) {
   ...
   // foreach($lineItems as $lineItem) {
     // $fedExShipment->setRequestedPackageLineItems($lineItem);
   // }
  ...
  private function _physicalWeightToFedex(PhysicalWeight $weight){
  ...
  private function _packageToFedexDimensions(PackageTypeInterface $package){
