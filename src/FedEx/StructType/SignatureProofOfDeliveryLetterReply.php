...
class SignatureProofOfDeliveryLetterReply extends AbstractStructBase
{
     ...
     * @param string $letter
     */
    public function __construct($highestSeverity = null, array $notifications = array(), \Drupal\commerce_fedex\FedEx\StructType\VersionId $version = null, \Drupal\commerce_fedex\FedEx\StructType\TransactionDetail $transactionDetail = null, $letter = null)
    {
        $this
     ...
     * @param string $highestSeverity
     * @return \Drupal\commerce_fedex\FedEx\StructType\SignatureProofOfDeliveryLetterReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $signatureProofOfDeliveryLetterReplyNotificationsItem) {
            ...
            if (!$signatureProofOfDeliveryLetterReplyNotificationsItem instanceof \Drupal\commerce_fedex\FedEx\StructType\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \Drupal\commerce_fedex\FedEx\StructType\Notification, "%s" given', is_object($signatureProofOfDeliveryLetterReplyNotificationsItem) ? get_class($signatureProofOfDeliveryLetterReplyNotificationsItem) : gettype($signatureProofOfDeliveryLetterReplyNotificationsItem)), __LINE__);
            }
        }
