...
/**
 * This class stands for ProcessShipmentRequest StructType
 * Meta informations extracted from the WSDL
 * - type: ns:ProcessShipmentRequest
 * @subpackage Structs
 */
class ProcessShipmentRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for ProcessShipmentRequest
     * @uses ProcessShipmentRequest::setWebAuthenticationDetail()
     * @uses ProcessShipmentRequest::setClientDetail()
     * @uses ProcessShipmentRequest::setVersion()
     * @uses ProcessShipmentRequest::setRequestedShipment()
     * @uses ProcessShipmentRequest::setTransactionDetail()
     ...
     * @param \Drupal\commerce_fedex\FedEx\StructType\WebAuthenticationDetail $webAuthenticationDetail
     * @return \Drupal\commerce_fedex\FedEx\StructType\ProcessShipmentRequest
     */
