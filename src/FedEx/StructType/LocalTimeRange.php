...
/**
 * This class stands for LocalTimeRange StructType
 * Meta informations extracted from the WSDL
 * - documentation: Time Range specified in local time.
 * @subpackage Structs
 */
class LocalTimeRange extends AbstractStructBase
{
    /**
     * The Begins
     * Meta informations extracted from the WSDL
    ...
    public $Ends;
    /**
     * Constructor method for LocalTimeRange
     * @uses LocalTimeRange::setBegins()
     * @uses LocalTimeRange::setEnds()
     * @param string $begins
     * @param string $ends
     */
     ...
     * Set Begins value
     * @param string $begins
     * @return \Drupal\commerce_fedex\FedEx\StructType\LocalTimeRange
     */
